...
return [
    ...
    'filename' => '/domains1/gh43616200/public/www_root/user/pages/02.o-cespo/02.co-nabizime/02.nahradni-plneni/blog_item.md',
    'modified' => 1600164197,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Náhradní plnění\'
cache_enable: true
continue_link: true',
        'markdown' => 'Text popisuje plnění povinného podílu zaměstnávání osob se zdravotním postižením (dále jen „OZP“) s vysvětlujícími příklady.
...
2.6.2.  Zodpovědnost dodavatele za správnost informací rozhodných pro výpočet náhradního plnění či zadávání údajů do evidence náhradního plnění není zákonem o zaměstnanosti řešena.
