...
return [
    ...
    'timestamp' => 1600756775,
    'checksum' => 'c7377f6d864a857c7500e05bcc846c44',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/map-quest' => [
                'file' => 'user/plugins/map-quest/blueprints.yaml',
                'modified' => 1600161750
            ],
        ...
        'user/themes' => [
            'themes/rt_zenith' => [
                'file' => 'user/themes/rt_zenith/blueprints.yaml',
                'modified' => 1600161753
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.map-quest.enabled' => [
                ...
                'name' => 'plugins.map-quest.enabled',
                'validation' => 'strict'
            ],
            'plugins.map-quest.api_key' => [
                'type' => 'text',
                'label' => 'API Key',
                'name' => 'plugins.map-quest.api_key',
                'validation' => 'strict'
            ],
            'plugins.markdown-notices' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'map-quest' => [
                    'enabled' => 'plugins.map-quest.enabled',
                    'api_key' => 'plugins.map-quest.api_key'
                ],
                'markdown-notices' => [
